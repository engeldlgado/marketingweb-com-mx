...
export default function Menu ({ setTheme, theme }) {
  return (
    <Popover className='relative bg-base-100 backdrop-filter backdrop-blur-md bg-opacity-20'>
      ...
      <div className='relative z-20'>
        <div className='flex items-center justify-between px-4 py-5 mx-auto max-w-7xl sm:px-6 sm:py-4 lg:px-8 md:justify-start md:space-x-10'>
          ...
          <div>
            <Link href='/' aria-label='hidden'><Logo className='w-20 md:w-24' /></Link>
          </div>
          ...
          <div className='flex items-center md:ml-12'>
            ...
            <a
              href='#'
              className='items-center justify-center hidden px-4 py-2 ml-8 text-base font-medium text-white transition-all duration-300 border border-transparent rounded-md shadow-sm bg-primary hover:bg-secondary md:inline-flex dark:hover:bg-indigo-800'
            >
              WhatsApp
            </a>
            <label
