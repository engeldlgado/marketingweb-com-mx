...
export default function MainHero () {
  ...
  return (
    <div id='home' className='py-12 lg:py-20 lg:overflow-hidden'>
        ...
        <div className='lg:grid lg:grid-cols-2 lg:gap-8'>
          <div className='z-10 max-w-md px-4 mx-auto sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center'>
            <div className='pt-20 pb-20 lg:pt-36 lg:pb-36'>
              ...
              <p className='mt-4 text-4xl font-extrabold tracking-tight text-center text-gray-900 transition-colors duration-500 dark:text-white md:text-left sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl'>
                <span className='block'>Tu página en el</span>
                <span className='block text-primary dark:text-primary'> Primer Lugar</span>
              </p>
              <p className='mt-3 text-base text-center text-text-gray-800 md:text-left dark:text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl'>
              ...
              <div className='flex flex-col items-center gap-6 mt-10 text-center duration-700 transform md:flex-row sm:mt-12 hover:scale-110'>
                {/* CTA for sales */}
                <span className='text-4xl tracking-tight text-gray-900 dark:text-white'>Desde <span className='text-4xl font-extrabold'>4.600$</span> <small className='font-normal'>MXN</small> al año</span>
      ...
      <div className='absolute top-0 w-full h-full overflow-hidden bg-gradient-165 from-secondary via-white to-white dark:from-primary dark:via-black dark:to-black -z-10'>
        <video
          ref={videoRef}
        ...
        <div className='absolute top-0 w-full h-full overflow-hidden bg-gradient-165 from-transparent via-white to-white dark:from-transparent dark:via-black dark:to-black -z-10' />

      </div>
      {/* <div className='relative right-0 h-32 -mt-40 -z-10 bg-gradient-to-b from-white via-white to-white dark:from-black dark:to-black md:-mt-40 lg:mt-0' /> */}
    </div>
  )
}
