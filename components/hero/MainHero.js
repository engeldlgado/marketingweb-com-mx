        ...
        <div className='lg:grid lg:grid-cols-2 lg:gap-8'>
          ...
          <div className='mt-12 -mb-0 sm:-mb-0 lg:m-0 lg:mt-36 lg:relative'>
            <div className='max-w-md px-4 mx-auto sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0'>
              ...
              <Image src='/images/hero.svg' className='z-0 hidden duration-500 transform md:flex hover:scale-105 ' alt='Agencia de Diseño Web y Marketing Digital' width={800} height={800} priority />
